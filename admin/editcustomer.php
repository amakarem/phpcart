...
if(isset($_POST) & !empty($_POST)){
		...
		$balance = filter_var($_POST['balance'], FILTER_SANITIZE_NUMBER_INT);
		$zip = filter_var($_POST['zipcode'], FILTER_SANITIZE_NUMBER_INT);

			//update data in usersmeta table
			$usql = "UPDATE usersmeta SET country='$country', firstname='$fname', lastname='$lname', address1='$address1', address2='$address2', city='$city', state='$state',  zip='$zip', company='$company', mobile='$phone', balance='$balance' WHERE id=$uid";
			$ures = mysqli_query($connection, $usql) or die(mysqli_error($connection)); 
}

$sql = "SELECT * FROM usersmeta WHERE id=$uid";
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div class="billing-details">
						...
						<label>Balance </label>
							<input name="balance" class="form-control" id="balance" placeholder="" value="<?php if(!empty($r['balance'])){ echo $r['balance']; }elseif(isset($balance)){ echo $balance; } ?>" type="text">
